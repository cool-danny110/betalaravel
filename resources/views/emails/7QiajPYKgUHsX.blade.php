    ...
    <div builder-element="PageElement" style="padding-top:50px;padding-bottom:50px;">
        <div builder-element="BlockElement" style="padding-top:55px;padding-bottom:15px;text-align:center;" class="">
            <div class="container">
                <div class="">
                    <div>
                        <img builder-element="" src="http://localhost/beta_laravel/public/templates/user/7QiajPYKgUHsX/image/logo_2.png" width="160px">
                    </div>
                    <h1 builder-element="" builder-inline-edit="" style="font-size: 18px" class="">News Digest</h1>
                </div>
            </div>
        </div>

        <div builder-element="BlockElement" style="opacity: 1;" class="">
            <div style="padding-top: 0px; padding-bottom: 0px;" class="container">
            <p builder-element="" builder-inline-edit="" class="" id="mce_5" style="position: relative; margin-bottom: 0px; color: rgb(128, 128, 128); font-size: 14px;" spellcheck="false">TOP STORIES FOR YOU</p></div>
        </div>

        <div builder-element="BlockElement" style="opacity: 1;" class="">
            <div style="padding-top:1px;padding-bottom:1px" class="container">
                <div builder-element="DividerElement" style="margin: 0;padding-top: 5px;padding-bottom:10px;"><hr style="margin: 0;"></div>
            </div>
        </div>
        
        <div builder-element="BlockElement" style="padding-top:15px;padding-bottom:15px" class="">
            <div class="container">
                <h5 builder-element="" builder-inline-edit="" style="font-size: 19px; font-weight: bold; position: relative;" class="mce-content-body" id="mce_0" contenteditable="true" spellcheck="false">What is the most Japanese thing ever? Who knows?</h5>
                <div class="d-flex align-items-center">
                    <div class="">
                        <img builder-element="" src="http://localhost/beta_laravel/public/templates/user/7QiajPYKgUHsX/image/avatar2.svg" width="32px">
                    </div>
                    <div>
                ...
                <div class="d-flex">
                    <div>
                        <p builder-element="" builder-inline-edit="" style="padding-right:16px">I worked in a government office in Japan twenty years ago. After one month on the job I returned to my desk (after being away the ENTIRE day) to find $3,000 worth of yen on... 
                    ...
                    <div>
                        <img builder-element="" src="http://localhost/beta_laravel/public/templates/user/7QiajPYKgUHsX/image/news1.jpg" width="140px">
                    </div>
                </div>
                <div>
                    <div class="d-flex align-items-center">
        ...
        <div builder-element="BlockElement" style="padding-top:15px;padding-bottom:15px">
            <div class="container d-flex justify-content-center">
                <div style="width:50%" class="border-bottom"></div>
            </div>
        </div>

        <div builder-element="BlockElement" style="padding-top:15px;padding-bottom:15px">
            <div class="container">
                <h5 builder-element="" builder-inline-edit="" style="font-size: 19px;font-weight: bold;">I have written a novel and it’s been proofread. Where do I get it published or should I self-publish it?</h5>
                <div class="d-flex align-items-center">
                    <div class="">
                        <img builder-element="" src="http://localhost/beta_laravel/public/templates/user/7QiajPYKgUHsX/image/avatar1.svg" width="32px">
                    </div>
                    <div>
                ...
                <div class="d-flex">
                    <div>
                        <p builder-element="" builder-inline-edit="" style="padding-right:16px">I’m a USA Today bestselling author, and own a small traditional publishing company. I’m also a ghostwriter and editor. The choices: 1. Traditional (never charges the author a... 
        ...
        <div builder-element="BlockElement" style="padding-top:15px;padding-bottom:15px" class="">
            <div class="container">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <img builder-element="" src="http://localhost/beta_laravel/public/templates/user/7QiajPYKgUHsX/image/avatar3.svg" width="32px">
                    </div>
                    <div>
                        <p builder-element="" builder-inline-edit="" class="mb-0 text-sm" style="font-size: 14px;">
                            <span class="fw-bold">	
                ...
                <div class="d-flex">
                    <div>
                        <p builder-element="" builder-inline-edit="" style="padding-right:16px">
                    ...
                    <div>
                        <img builder-element="" src="http://localhost/beta_laravel/public/templates/user/7QiajPYKgUHsX/image/news3.jpeg" width="140px">
                    </div>
                </div>
                <div>
                    <div class="d-flex align-items-center">
