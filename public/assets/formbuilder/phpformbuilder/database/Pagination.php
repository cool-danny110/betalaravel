...
class Pagination extends Mysql
{
    ...
    private $first_markup       = '<i class="bi bi-chevron-double-left"></i>';
    private $previous_markup    = '<i class="bi bi-chevron-left"></i>';
    private $next_markup        = '<i class="bi bi-chevron-right"></i>';
    private $last_markup        = '<i class="bi bi-chevron-double-right"></i>';
